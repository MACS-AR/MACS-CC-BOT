        ...
        if(preg_match_all("/(\d{16})[\/\s:|]*?(\d\d)[\/\s|]*?(\d{2,4})[\/\s|-]*?(\d{3})/", $lista, $matches)) {
            ...
            if(!preg_match_all("/sk_(test|live)_[A-Za-z0-9]+/", $sec, $matches)) {
                bot('editMessageText',[
                    ...
                    'text'=>"<b>أضف مفتاح SK أولاً باستخدام /apikey sk_live</b>",
                    'parse_mode'=>'html',
...
<b> الحالة - »ميت ❌
الاستجابة - »<code> SK Key is dead </code>
البوابة - »Stripe Auth 1
زمن -» <b>$time</b><b>s</b>
...
<b>Bot By: <a href='t.me/MACS31'>MR_MACS</a></b>",
              ...
              bot('editMessageText',[
                ...
                'text'=>"<b>Card:</b> <code>$lista</code>
<b> الحالة - »ميت ❌
الاستجابة - »<code> $stripemessage </code>
البوابة - »Stripe Auth 1
زمن-» <b>$time</b><b>s</b>
...
<b>Bot By: <a href='t.me/MACS31'>MR_MACS</a></b>",
            ...
            bot('editMessageText',[
                'chat_id'=>$chat_id,
                'message_id'=>$messageidtoedit,
                'text'=>"<b>بارد! الداعر يقدم نسخة للتحقق!!</b>",
                'parse_mode'=>'html',
                'disable_web_page_preview'=>'true'
